 ...
 *
 * Standalone module — relocated out of the Exotopia app tree (originally
...
const STANDARD_SPLIT: ResonanceSplit = Object.freeze({
  creator:        0.99,
...
function toSunlightShape(s: ResonanceSplit) {
