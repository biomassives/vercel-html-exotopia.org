...
const LIVE_GROUPS = [
  ...
  },
  {
    ...
    features: [
      ...
      { url: '/ecology-citizen-science', desc: 'Ecology/biodiversity site research → letter-of-inquiry → field logging workflow, browse/start sites and projects', data: 'Supabase 009_ecology_biodiversity.sql' },
...
const BUILDING = [
  ...
  {
    title: 'Ecology & Biodiversity citizen science tooling',
    shipped: true,
    desc: 'The logging-table equivalent of the PFAS tooling above, for ecology/biodiversity field work (forest gardens, rain gardens, bird blinds, biodiversity surveys, habitat restoration). Adds a site-access lifecycle PFAS\'s focus_areas doesn\'t have — map research → letter of inquiry → confirmed access — with a letter-of-inquiry generator and the underlying site-securing field guide built in.',
    url: '/ecology-citizen-science',
    details: [
      'supabase/migrations/009_ecology_biodiversity.sql → ecology_sites (with access_status lifecycle), ecology_projects, ecology_log_entries, points_catalog ecology_field_log entry',
      'src/data/ecology-fieldwork-library.ts → map-research steps, site-type → contact-pathway table, letter-of-inquiry generator, site assessment checklist — operationalizes docs/eco-ops-workflow-guide.md Part 1',
      'SPEC_ECOLOGY_ADJACENT_DOMES.md → the settlement-visual follow-up this table unblocks (a generated-biome "Ecology Annex" dome), not built yet',
    ],
  },
  {
...
const URL_API_GROUPS = [
  ...
  },
  {
    ...
    entries: [
      ...
      { pattern: '/mint',                               desc: 'Settlement deed claiming + IPFS pin' },
      ...
      { pattern: '/ecology-citizen-science',             desc: 'Ecology/biodiversity site research + field logging' },
