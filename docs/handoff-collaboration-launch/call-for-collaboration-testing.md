...
1. Read the current status report (`status-report-aug17-2026.md` in the repo, or linked from
...
- *This assumes `status-report-aug17-2026.md` gets linked from somewhere public (a blog post
